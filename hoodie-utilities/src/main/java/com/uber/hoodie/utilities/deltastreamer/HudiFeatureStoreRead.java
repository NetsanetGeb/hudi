...
public class HudiFeatureStoreRead {

    static Logger logger = Logger.getLogger(HudiFeatureStoreRead.class.getName());
    ...
    public static void main(String[] args){
        ...
        Dataset<Row> df= Hops.getFeaturegroup("stock_featuregroup").setSpark(spark).setFeaturestore(Hops.getProjectFeaturestore().read()).setVersion(1)
                           .setHudi(true).setHudiArgs(hudiArgs).setHudiTableBasePath("/Projects/Hudi/Output/newSTOCK_FEATUREGROUP_1").read();
